...
public class BlockRockDust extends Block implements IBreathable {
	...
	public void updateTick(World world, int x, int y, int z, Random rand) {
		...
		if(rand.nextInt(8) == 0) {
			...
			for(int i = wID.length-1; i>=0; --i) {
				if(wID[i].getMaterial() == Material.air) {
					switch (i) {
						case 0:
							if(rand.nextInt(4) > 0)
								world.setBlock(x+1, y, z, this, m-1, 3);
							break;
						case 1:
							if(rand.nextInt(4) > 0)
								world.setBlock(x-1, y, z, this, m-1, 3);
						...
						case 2:
							if(rand.nextBoolean())
								world.setBlock(x, y+1, z, this, m-1, 3);
							break;
						case 3:
							world.setBlock(x, y-1, z, this, m-1, 3);
							break;
						case 4:
							if(rand.nextInt(4) > 0)
								world.setBlock(x, y, z+1, this, m-1, 3);
							break;
						case 5:
							if(rand.nextInt(4) > 0)
								world.setBlock(x, y, z-1, this, m-1, 3);
			...
			if(wID[i].getMaterial() == Material.air) {
				...
				switch (i) {
					case 0:
						world.setBlock(x+1, y, z, this, m, 3);
						break;
					case 1:
						world.setBlock(x-1, y, z, this, m, 3);
						break;
					case 2:
						if(rand.nextBoolean())
							world.setBlock(x, y+1, z, this, m, 3);
						break;
					case 3:
						world.setBlock(x, y-1, z, this, m, 3);
						break;
					case 4:
						world.setBlock(x, y, z+1, this, m, 3);
						break;
					case 5:
						world.setBlock(x, y, z-1, this, m, 3);
						break;
    ...
    public int onBlockPlaced(World par1World, int x, int y, int z, int par5, float par6, float par7, float par8, int par9) {
    	par1World.scheduleBlockUpdate(x, y, z, this, tickRate(par1World));
	    return 8;
    }
