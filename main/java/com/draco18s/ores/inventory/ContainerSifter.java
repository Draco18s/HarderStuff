...
public class ContainerSifter extends Container {
	...
	public ContainerSifter(InventoryPlayer inventoryPlayer, TileEntitySifter te) {
		tileEntity = te;
		addSlotToContainer(new SlotDust(tileEntity, 0, 89, 11));
		addSlotToContainer(new SlotDust(tileEntity, 1, 71, 11));
		addSlotToContainer(new SlotOutput(tileEntity, 2, 80, 56));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotNum) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotNum > 2) {
                if (RecipeManager.getSiftResult(itemstack1, false) != null) {
