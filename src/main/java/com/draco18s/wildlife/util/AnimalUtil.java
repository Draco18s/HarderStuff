...
public class AnimalUtil implements IAnimals {
		...
		for(String s:list) {
			if(s.indexOf(".") >= 0) {
				...
				try {
					...
					WildlifeBase.logger.log(Level.ERROR, "No entity found for " + s); //net.minecraft.entity.passive.Entity
