...
public class ContainerSifter extends Container {
	protected TileEntitySifter tileEntity;

	public ContainerSifter(InventoryPlayer inventoryPlayer, TileEntitySifter te) {
		tileEntity = te;
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotNum) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotNum > 2) {
                if (HardLibAPI.recipeManager.getSiftResult(itemstack1, false) != null) {
