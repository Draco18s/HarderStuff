...
public class ContainerSluiceB extends Container {
	protected TileEntitySluiceBottom tileEntity;

	public ContainerSluiceB(InventoryPlayer inventoryPlayer, TileEntitySluiceBottom te) {
		tileEntity = te;
		addSlotToContainer(new SlotGravel(tileEntity, 0, 16, 18));
		addSlotToContainer(new SlotGravel(tileEntity, 1, 95, 11));
		/*for(int i=1;i<=3;i++) {
			for(int j=0;j<3;j++) {
