...
public class ContainerProcessor extends Container {
	protected TileEntityOreProcessor tileEntity;

	public ContainerProcessor(InventoryPlayer inventoryPlayer, TileEntityOreProcessor te) {
		tileEntity = te;
		addSlotToContainer(new SlotDust(tileEntity, 0, 89, 13));
		addSlotToContainer(new SlotDust(tileEntity, 1, 71, 13));
		addSlotToContainer(new SlotOutput(tileEntity, 2, 80, 58));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotNum) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotNum > 2) {
                if (HardLibAPI.recipeManager.getProcessorResult(itemstack1, false) != null) {
