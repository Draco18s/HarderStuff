...
public class BlockOreOsmium extends BlockHardOreBase {
	
	public BlockOreOsmium() {
		super(EnumOreType.OSMIUM, 1, 9, 150, 20, 5, 9);
		setBlockName("ore_osmium");
		setHardness(6.0f);
		setHarvestLevel("pickaxe", 1);
        setBlockTextureName("osmium_ore");
	}
